...
export const createFhevmInstance = async (parameters: {
  ...
  if (isMock) {
    ...
    if (fhevmRelayerMetadata) {
      ...
      // For mock mode, we would use a mock instance
      // For now, we'll skip mock mode and use the real SDK
      throw new Error("Mock mode not implemented. Please use Sepolia testnet.");
    }
  }
